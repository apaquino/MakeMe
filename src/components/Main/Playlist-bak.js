...
class Playlist extends Component {
    ...
    return (
      <View style={styles.tester}>
        <Image source={image} style={styles.backgroundImage}>
          <TouchableHighlight onPress={() => console.log("show routine coming soon")}>
            <Text style={styles.routineName}>{routine.name}</Text>
          </TouchableHighlight>
          <TouchableHighlight onPress={() => console.log("show trainer coming soon"))}>
            <Text style={styles.trainerName}>{routine.trainer}</Text>
          </TouchableHighlight>
          <Text style={styles.routineLevel}>Level {routine.level}</Text>
          <Button
            onPress={() => console.log("Go coming soon")}
  ...
  render() {
    ...
    justifyContent: 'center'}}>
        ...
        <Text>Playlist test - Go to routine</Text>
        </TouchableHighlight>
        <TouchableHighlight onPress={Actions.trainershow} >
        <Text>Playlist test - Go to trainer</Text>
        </TouchableHighlight>
        <TouchableHighlight onPress={Actions.tab3} >
        <Text>Playlist test - Go to tab3 "GO"</Text>
        </TouchableHighlight>
      </View>
    )
  }
